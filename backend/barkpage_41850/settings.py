"""
Django settings for barkpage_41850 project.
...
ROOT_URLCONF = 'barkpage_41850.urls'
...
WSGI_APPLICATION = 'barkpage_41850.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "barkpage_41850 API",
    "DESCRIPTION": "API documentation for barkpage_41850 App",
    "VERSION": "v1",
}
